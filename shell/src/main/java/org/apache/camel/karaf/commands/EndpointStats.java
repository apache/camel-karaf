...
@Service
public class EndpointStats extends CamelController implements Action {
    ...
    public Object execute() throws Exception {
        List<Map<String, String>> contexts = getCamelContexts(name);
        ...
        for (Map<String, String> context : contexts) {
            ...
            List<Map<String, String>> endpoints = getEndpointRuntimeStatistics(contextName);
        ...
        for (Map.Entry<String, List<Map<String, String>>> entry : allEndpoints.entrySet()) {
            ...
            for (Map<String, String> row : entry.getValue()) {
                ...
                if (!header) {
                    System.out.println(String.format(headerFormat, CONTEXT_COLUMN_LABEL, URI_COLUMN_LABEL,
                ...
                if (isValidRow(direction, isStatic, isDynamic)) {
                    System.out.println(String.format(rowFormat, contextName, uri, routeId, direction, isStatic, isDynamic, hits));
                }
            }
        }
        return null;

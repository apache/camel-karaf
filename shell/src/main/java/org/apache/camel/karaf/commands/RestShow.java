...
@Service
public class RestShow extends CamelController implements Action {
    ...
    public Object execute() throws Exception {
        String xml = getRestModelAsXml(name);
        if (xml == null) {
            System.out.println("There are no REST services in CamelContext with name: " + name);
        } else {

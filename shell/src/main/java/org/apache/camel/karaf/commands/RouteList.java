...
@Service
public class RouteList extends CamelController implements Action {
    ...
    public Object execute() throws Exception {
        List<Map<String, String>> routes = getRoutes(name);
        ...
        if (routes.size() > 0) {
            System.out.println(String.format(headerFormat, CONTEXT_COLUMN_LABEL, ROUTE_COLUMN_LABEL, STATUS_COLUMN_LABEL, TOTAL_COLUMN_LABEL, FAILED_COLUMN_LABEL, INFLIGHT_COLUMN_LABEL,
                    UPTIME_COLUMN_LABEL));
            ...
            for (Map<String, String> row : routes) {
                ...
                System.out.println(String.format(rowFormat, contextId, routeId, state, total, failed, inflight, uptime));
            }
        }
        return null;
    }

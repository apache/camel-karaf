...
@Service
public class ContextInFlight extends CamelController implements Action {
    ...
    public Object execute() throws Exception {
        List<Map<String, Object>> inflight = this.browseInflightExchanges(name, route, limit, sortByLongestDuration);
        ...
        if (inflight.size() > 0) {
            System.out.println(String.format(headerFormat, EXCHANGE_COLUMN_LABEL, FROM_ROUTE_COLUMN_LABEL, ROUTE_COLUMN_LABEL, NODE_COLUMN_LABEL, ELAPSED_COLUMN_LABEL, DURATION_COLUMN_LABEL));
            ...
            for (Map<String, Object> row : inflight) {
                ...
                System.out.println(String.format(rowFormat, exchangeId, fromRouteId, routeId, nodeId, safeNull(elapsed), safeNull(duration)));
            }
        }

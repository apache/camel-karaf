...
public class CamelDockerRouteSupplier extends AbstractCamelSingleFeatureResultMockBasedRouteSupplier {
    ...
    protected void configureProducer(RouteBuilder builder, RouteDefinition producerRoute) {
        producerRoute.log("Will ping")
                    ...
                    .log("Will pull image")
                    .setHeader("CamelDockerUsername", builder.constant(DOCKER_USERNAME))
                    .setHeader("CamelDockerRepository", builder.constant(DOCKER_TEST_IMAGE))
                    ...
                    .setHeader("CamelDockerImageId", builder.constant(DOCKER_TEST_IMAGE))

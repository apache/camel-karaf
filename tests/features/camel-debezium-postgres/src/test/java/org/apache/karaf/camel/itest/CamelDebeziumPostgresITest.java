...
public class CamelDebeziumPostgresITest extends AbstractCamelSingleFeatureResultMockBasedRouteITest {
    ...
    @Test
    @Ignore("TODO: Service factory exception: Unable to instantiate class class io.debezium.transforms.outbox.EventRouter Does it have a public no-arg constructor?")
